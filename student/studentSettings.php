...
<body>
    ...
    <div class="homeButtons">
        <a href="settings/accountInformation.php"><button class="accinfo">Account Information</button></a><br>
        <a href="settings/changePassword.php"><button class="unblock">Change Password</button></a><br>
        <a href="studentHomepage.php"><button class="back">Back</button></a><br>
    </div>
</body>
</html>