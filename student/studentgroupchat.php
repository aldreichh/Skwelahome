...
<body>
    ...
    <div class="bodycontainer">
        ...
        <div class="messagecontainer">
            <div class="messagecontainer2">
                ...
                $sql = "SELECT subject_id, full_name, group_message, sent_by, sent_on FROM groupchat WHERE subject_id = '$subjectid'";
    ...
    if(isset($_POST['btn'])&&isset($_POST['message_text']))
    {
        ...
        {
            echo "<script>location.href='studentgroupchat.php'</script>"; 
