...
<body>
    ...
    <div class="formContainer">
        <?php 
            ...
            $sql = "SELECT subject_id, sub_name, full_name FROM student_subjects WHERE sub_name = '$selected'";
            ...
            echo "<select name='studname' id='studname' class='selection' required>";
            ...
            if(isset($_POST['studname'])&&isset($_POST['btn']))
            {
                $selected = $_POST["studname"];
                $sql = "DELETE FROM student_subjects WHERE full_name = '$selected'";

                if ($conn->query($sql) === TRUE)
                    echo "<script>location.href='unenrollStudent2.php'</script>";
                else
