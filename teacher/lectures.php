...
<body>
                ...
                <div class="textfields">
                    <div class="topicinput">
                        <textarea 
                          ...
                          rows="1" 
                          name="message_topic" 
                          placeholder="Input topic" required></textarea>
                    </div>
                    <div class="linkinput">
                        <textarea 
                          id="text" 
                          ...
                          rows="1" 
                          name="message_link" 
                          placeholder="Paste file link" required></textarea>
                    </div>
                <div class="buttons">
    ...
    if(isset($_POST['btn'])&&isset($_POST['message_link'])&&isset($_POST['message_topic']))
    {
        $link = $_POST['message_link'];
        $topic = $_POST['message_topic'];
        $conn = new mysqli($servername, $username, $password, $dbname);
        ...
        $sql = "INSERT INTO lectures (subject_id, topic, link, posted_by, posted_on) VALUES ('$subjectid', '$topic', '$link', '$uname', CURRENT_TIMESTAMP)";

        if ($conn->query($sql) === TRUE)
        {
            echo "<script>location.href='lectures.php'</script>"; 
