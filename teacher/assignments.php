    ...
    <div class="bodycontainer">
                ...
                if(!$length==0)
                {
                    echo "<div class='container'>";
                        for($i=$length-1;$i>=0;$i--)
                        {
                            ...
                            echo "</div>";
                            echo "<br>";
                            echo '<button name="viewbtn" class="viewbtn" value='.$array4[$i].' type="submit">'."View Student responses".'</button>';
                            echo "<br>"."<br>";
                            echo "</form>";
                            if(isset($_POST["viewbtn"]))
                            {
                                $selected = $_POST["viewbtn"];
                                $_SESSION["selectedview"] = $selected;
        ...
        <div class="addcontainer">
            <div class="addcontainer2">
                ...
                <input type="date" class="deadline" id="start" name="deadline"
                       value="2022-01-01"
